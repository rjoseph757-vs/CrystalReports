...
Crystal Decisions Technical Support - vbnet_win_dbviewer.exe
...
This Visual Basic .NET sample Windows application demonstrates how to connect a report to a secured database using the Windows Form Viewer's object model.
...
1. Extract this file to the default installation folder, C:\Crystal\crnet\vbnet_win_dbviewer. 
...
A report appears after logging into the secured database using the Windows Form Viewer.
________________________________________________________________ 
