...
namespace WindowsFormsAppCrystalReport2021.Reports {
    ...
    public class NPCodeAnalysis : ReportClass {
        
        public NPCodeAnalysis() {
        }
        
        public override string ResourceName {
            get {
                return "NPCodeAnalysis.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsAppCrystalReport2021.Reports.NPCodeAnalysis.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedNPCodeAnalysis : Component, ICachedReport {
        
        public CachedNPCodeAnalysis() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            NPCodeAnalysis rpt = new NPCodeAnalysis();
            rpt.Site = this.Site;
            return rpt;
        }
