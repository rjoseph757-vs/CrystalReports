...
namespace WindowsFormsAppCrystalReport2021.Reports {
    ...
    public class TelDirByState : ReportClass {
        
        public TelDirByState() {
        }
        
        public override string ResourceName {
            get {
                return "TelDirByState.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsAppCrystalReport2021.Reports.TelDirByState.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedTelDirByState : Component, ICachedReport {
        
        public CachedTelDirByState() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            TelDirByState rpt = new TelDirByState();
            rpt.Site = this.Site;
            return rpt;
        }
