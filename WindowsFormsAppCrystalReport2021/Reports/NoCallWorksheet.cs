...
namespace WindowsFormsAppCrystalReport2021.Reports {
    ...
    public class NoCallWorksheet : ReportClass {
        
        public NoCallWorksheet() {
        }
        
        public override string ResourceName {
            get {
                return "NoCallWorksheet.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsAppCrystalReport2021.Reports.NoCallWorksheet.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedNoCallWorksheet : Component, ICachedReport {
        
        public CachedNoCallWorksheet() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            NoCallWorksheet rpt = new NoCallWorksheet();
            rpt.Site = this.Site;
            return rpt;
        }
