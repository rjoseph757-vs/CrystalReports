...
namespace WindowsFormsAppCrystalReport2021.Reports {
    ...
    public class SalesActivityDueDatePState : ReportClass {
        
        public SalesActivityDueDatePState() {
        }
        
        public override string ResourceName {
            get {
                return "SalesActivityDueDatePState.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsAppCrystalReport2021.Reports.SalesActivityDueDatePState.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSalesActivityDueDatePState : Component, ICachedReport {
        
        public CachedSalesActivityDueDatePState() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SalesActivityDueDatePState rpt = new SalesActivityDueDatePState();
            rpt.Site = this.Site;
            return rpt;
        }
