...
namespace WindowsFormsAppCrystalReport2021.Reports {
    ...
    public class PC_Check1Up : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsAppCrystalReport2021.Reports.PC_Check1Up.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPC_Check1Up : Component, ICachedReport {
        
        public CachedPC_Check1Up() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PC_Check1Up rpt = new PC_Check1Up();
            rpt.Site = this.Site;
            return rpt;
        }
