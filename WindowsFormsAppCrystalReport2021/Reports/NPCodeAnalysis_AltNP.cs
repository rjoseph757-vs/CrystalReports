...
namespace WindowsFormsAppCrystalReport2021.Reports {
    ...
    public class NPCodeAnalysis_AltNP : ReportClass {
        
        public NPCodeAnalysis_AltNP() {
        }
        
        public override string ResourceName {
            get {
                return "NPCodeAnalysis_AltNP.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsAppCrystalReport2021.Reports.NPCodeAnalysis_AltNP.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedNPCodeAnalysis_AltNP : Component, ICachedReport {
        
        public CachedNPCodeAnalysis_AltNP() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            NPCodeAnalysis_AltNP rpt = new NPCodeAnalysis_AltNP();
            rpt.Site = this.Site;
            return rpt;
        }
