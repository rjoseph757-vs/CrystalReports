...
namespace WindowsFormsAppCrystalReport2021.Reports {
    ...
    public class AdProjectsInProgress01DetailNew : ReportClass {
        
        public AdProjectsInProgress01DetailNew() {
        }
        
        public override string ResourceName {
            get {
                return "AdProjectsInProgress01DetailNew.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsAppCrystalReport2021.Reports.AdProjectsInProgress01DetailNew.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAdProjectsInProgress01DetailNew : Component, ICachedReport {
        
        public CachedAdProjectsInProgress01DetailNew() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AdProjectsInProgress01DetailNew rpt = new AdProjectsInProgress01DetailNew();
            rpt.Site = this.Site;
            return rpt;
        }
