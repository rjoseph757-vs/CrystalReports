...
namespace WindowsFormsAppCrystalReport2021.Reports {
    ...
    public class PublicationList : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsAppCrystalReport2021.Reports.PublicationList.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedPublicationList : Component, ICachedReport {
        
        public CachedPublicationList() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            PublicationList rpt = new PublicationList();
            rpt.Site = this.Site;
            return rpt;
        }
