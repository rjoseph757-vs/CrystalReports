...
namespace WindowsFormsAppCrystalReport2021.Reports {
    ...
    public class AdProjectsInProgress01DetailRevised : ReportClass {
        
        public AdProjectsInProgress01DetailRevised() {
        }
        
        public override string ResourceName {
            get {
                return "AdProjectsInProgress01DetailRevised.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsAppCrystalReport2021.Reports.AdProjectsInProgress01DetailRevised.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAdProjectsInProgress01DetailRevised : Component, ICachedReport {
        
        public CachedAdProjectsInProgress01DetailRevised() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            AdProjectsInProgress01DetailRevised rpt = new AdProjectsInProgress01DetailRevised();
            rpt.Site = this.Site;
            return rpt;
        }
