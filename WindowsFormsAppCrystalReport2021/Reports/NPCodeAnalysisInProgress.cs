...
namespace WindowsFormsAppCrystalReport2021.Reports {
    ...
    public class NPCodeAnalysisInProgress : ReportClass {
        
        public NPCodeAnalysisInProgress() {
        }
        
        public override string ResourceName {
            get {
                return "NPCodeAnalysisInProgress.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "WindowsFormsAppCrystalReport2021.Reports.NPCodeAnalysisInProgress.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedNPCodeAnalysisInProgress : Component, ICachedReport {
        
        public CachedNPCodeAnalysisInProgress() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            NPCodeAnalysisInProgress rpt = new NPCodeAnalysisInProgress();
            rpt.Site = this.Site;
            return rpt;
        }
